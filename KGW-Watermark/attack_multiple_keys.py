# coding=utf-8
# Attack the watermark with multiple keys
    ...
    if not args.skip_model_load:
        ...
        for idx in tqdm.tqdm(range(500)):
            ...
            _, _, decoded_output_without_watermark, decoded_output_with_watermark, _ = generate(input_text, 
                                                                                                ...
                                                                                                tokenizer=tokenizer)
            if not args.multiple_key:
                decoded_output_without_watermark = decoded_output_without_watermark[len(input_text):]
                without_watermark_detection_result = detect(decoded_output_without_watermark, 
                                                            args, 
                                                            device=device, 
                                                            tokenizer=tokenizer)

            decoded_output_with_watermark = decoded_output_with_watermark[len(input_text):]
            ...
            if not args.multiple_key:
                ...
                watermarked_file_name = './results/multiple_keys/watermarked_13b.pkl'
                unwatermarked_file_name = './results/multiple_keys/unwatermarked_13b.pkl'

                detect_watermarked_file_name = './results/multiple_keys/detect_watermarked_13b.pkl'
                detect_unwatermarked_file_name = './results/multiple_keys/detect_unwatermarked_13b.pkl'
                if (idx + 1) % 10 == 0:
                ...
                watermark_removal_file_name = './results/multiple_keys/watermark_removal_keys_' + str(args.num_keys) + '_13b.pkl'

                detect_watermark_removal_file_name = './results/multiple_keys/detect_watermark_removal_keys_' + str(args.num_keys) + '_13b.pkl'
                if (idx + 1) % 10 == 0:
